...
export const filterAffairs = (affairs: Array<AffairType>, newFilter: FilterType): AffairType[] => { // need to fix any
    if (newFilter === 'all') {
        return affairs;
    }
    return affairs.filter(affair => affair.priority === newFilter); // need to fix
}
export const deleteAffair = (affairs: Array<AffairType>, _id: number): AffairType[] => { // need to fix any
    let updateAffair = affairs.filter(a => a._id !== _id)
    return [...updateAffair] // need to fix
}
